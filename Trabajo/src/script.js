let playlist = [ {
  ...
  'audio': "assets/Attention-Charlie Puth.mp3",
}, {
  'title': 'Another One Bites The Dust • Queen',
  'audio': "assets/Another One Bites The Dust • Queen.mp3",
},{
  'title': 'Im Still Standing-Taron Egerton',
  'audio': "assets/Im Still Standing-Taron Egerton.mp3",
},{
  'title': 'Bee Gees - Stayin Alive',
  'audio': "assets/Bee Gees - Stayin Alive.mp3",
},{
  'title': 'Coldplay - Hymn For The Weekend',
  'audio': "assets/Coldplay - Hymn For The Weekend.mp3",
} ];
i = 0;
n = playlist.length;
